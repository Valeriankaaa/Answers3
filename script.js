...
let txt1 = 'я люблю JS!'
console.log(txt1.substr(2,5));
console.log(txt1.substring(2,7));
console.log(txt1.slice(2,7));

// Дана строка 'я люблю JS!'. Найдите позицию 
// подстроки 'люблю'.

console.log(txt1.indexOf('люблю'));
...
let txt5 = 'Я пытаюсь разобраться в JS и понять хоть что-то';
let n = 26;
let result;

if (txt5.length > n) {
result = txt5.slice(0, n);
console.log(result + '... ');
} else {
result = txt5;
console.log(result);
